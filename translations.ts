...
export const translations = {
  en: {
    ...
    catalog: {
      ...
      categoryModalSubtitle: "Create, rename or remove categories",
      newCategoryPlaceholder: "Category name...",
      addCategoryBtn: "Add Category",
      inUseWarning: "This category is in use and cannot be deleted.",
  ...
  pt: {
    ...
    catalog: {
      ...
      inUseWarning: "Esta categoria está em uso e não pode ser eliminada.",
